...
#ifndef CRYSTAL_DOCK_BUDGIE_DESKTOP_ENV_H_
#define CRYSTAL_DOCK_BUDGIE_DESKTOP_ENV_H_

#include "desktop_env.h"

namespace crystaldock {

class BudgieDesktopEnv : public DesktopEnv {
 public:
...
#endif // CRYSTAL_DOCK_BUDGIE_DESKTOP_ENV_H_
