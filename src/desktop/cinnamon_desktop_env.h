...
#ifndef CRYSTALDOCK_CINNAMON_DESKTOP_ENV_H_
#define CRYSTALDOCK_CINNAMON_DESKTOP_ENV_H_

#include "desktop_env.h"

namespace crystaldock {

class CinnamonDesktopEnv : public DesktopEnv {
 public:
...
#endif // CRYSTALDOCK_CINNAMON_DESKTOP_ENV_H_
