...
#ifndef CRYSTALDOCK_MATE_DESKTOP_ENV_H_
#define CRYSTALDOCK_MATE_DESKTOP_ENV_H_

#include "desktop_env.h"

namespace crystaldock {

class MateDesktopEnv : public DesktopEnv {
 public:
...
#endif // CRYSTALDOCK_MATE_DESKTOP_ENV_H_
